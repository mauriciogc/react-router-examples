...
const Home = () => {
	...
	const handlePersonalAbout = () => history.push("/about/mauricio"); //add programmatic routing
	...
	return (
		<div>
			...
			<button onClick={handlePersonalAbout}>
				Go to "About" with params "/about/mauricio"
			</button>
			<hr />
		</div>
	);
